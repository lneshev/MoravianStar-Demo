...
{
    /// <inheritdoc cref="EntityRestController{TEntity, TId, TModel, TFilter, DataLayer_SystemContext}"/>
    public abstract class SystemEntityRestController<TEntity, TId, TModel, TFilter> : EntityRestController<TEntity, TId, TModel, TFilter, DataLayer_SystemContext>
