...
{
    /// <inheritdoc cref="EntityRestController{TEntity, TId, TModel, TFilter, DataLayer_ClientDMLContext}"/>
    public abstract class ClientEntityRestController<TEntity, TId, TModel, TFilter> : EntityRestController<TEntity, TId, TModel, TFilter, DataLayer_ClientDMLContext>
